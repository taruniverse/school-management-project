...
$(document).ready(function () {
  ...
  if ($('#student-chart').length > 0) {
    ...
    var donut = new ApexCharts(document.querySelector('#student-chart'), donutChart);
  ...
  if ($('#teacher-chart').length > 0) {
    ...
    var donut = new ApexCharts(document.querySelector('#teacher-chart'), donutChart);
  ...
  if ($('#staff-chart').length > 0) {
    ...
    var donut = new ApexCharts(document.querySelector('#staff-chart'), donutChart);
  ...
  if ($('#class-chart').length > 0) {
    ...
    var donut = new ApexCharts(document.querySelector('#class-chart'), donutChart);
  ...
  if ($('#attendance_chart').length > 0) {
    ...
    var donut = new ApexCharts(document.querySelector('#attendance_chart'), donutChart);
  ...
  if ($('#plan_chart').length > 0) {
    ...
    var donut = new ApexCharts(document.querySelector('#plan_chart'), donutChart);
  ...
  if ($('#attendance_chart2').length > 0) {
    ...
    var donut = new ApexCharts(document.querySelector('#attendance_chart2'), donutChart);
  ...
  if ($('#total-earning').length > 0) {
    ...
    var chart = new ApexCharts(document.querySelector('#total-earning'), sLineArea);
  ...
  if ($('#total-expenses').length > 0) {
    ...
    var chart = new ApexCharts(document.querySelector('#total-expenses'), sLineArea);
